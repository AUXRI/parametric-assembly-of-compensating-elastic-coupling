...
void CkursachView::DisplayImage()
{
    ...
    // Загрузка первой картинки
    if (image1.Load(_T("F:/vus/vsprg/sim_3/курсач/kursach/img/1isp.jpg")) != S_OK)
    {
        OutputDebugString(_T("Не удалось загрузить первую картинку\n"));
        return;
    }
    ...
    // Загрузка второй картинки
    if (image2.Load(_T("F:/vus/vsprg/sim_3/курсач/kursach/img/1isp_2.jpg")) != S_OK)
    {
        OutputDebugString(_T("Не удалось загрузить вторую картинку\n"));
        return;
    }
...
void CkursachView::DisplayImage2()
{
    ...
    // Загрузка первой картинки
    if (image1.Load(_T("F:/vus/vsprg/sim_3/курсач/kursach/img/2isp.jpg")) != S_OK)
    {
        OutputDebugString(_T("Не удалось загрузить первую картинку\n"));
        return;
    }
    ...
    // Загрузка второй картинки
    if (image2.Load(_T("F:/vus/vsprg/sim_3/курсач/kursach/img/2isp_2.jpg")) != S_OK)
    {
        OutputDebugString(_T("Не удалось загрузить вторую картинку\n"));
        return;
    }
